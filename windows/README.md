...
This directory contains all Windows-specific files for HyPanel.

## Available Files:

- **hypanel-windows.xml**: Windows Service configuration
- **install-windows.bat**: Installation script
- **hypanel-windows.bat**: Control panel
...
To install HyPanel on Windows:
1. Run `install-windows.bat` as Administrator
2. Follow the installation wizard
3. Use `hypanel-windows.bat` for management
